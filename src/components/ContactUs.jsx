...
const ContactUs = () => {
  return (
    <div className='w-full bg-black py-16 px-4'>
      ...
      <h2 className="mb-4 text-3xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Call Us</h2>
      <div className='flex justify-center'> 
        ...
        <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl underline">305-322-0401.</p>
        <FaPhone className='mb-8 lg:mb-16 text-center text-gray-500 dark:text-gray-400 sm:text-xl ml-4'/>
      </div>
      <h2 className="mb-4 text-3xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Email Us</h2>
      <div className='flex justify-center'> 
        <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl mr-2">Email us at </p>
        <a className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl underline">support@codeenclave.com.</a>
        <MdEmail className='mb-8 lg:mb-16 text-center text-gray-500 dark:text-gray-400 sm:text-xl ml-4'/>
      </div>
