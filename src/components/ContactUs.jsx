  ...
  return (
    <div className='w-full bg-black py-16 px-4'>
      ...
      <div className='flex justify-center'> 
        ...
        <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-white sm:text-xl">305-322-0401</p>
      ...
      <div className='flex justify-center'> 
        ...
        <a className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-white sm:text-xl ">support@codeenclave.com</a>
