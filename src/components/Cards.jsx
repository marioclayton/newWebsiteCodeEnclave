      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <div className='text-center font-medium'>
                ...
                <p className='py-2 border-b mx-8'>Optimzed for SEO</p>
                <p className='py-2 border-b mx-8'>3 Revisions</p>
              </div>
              <button className='bg-[#a6a6a6] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
          </div>
          <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
              ...
              <div className='text-center font-medium'>
                ...
                <p className='py-2 border-b mx-8'>Responsive Deisgn</p>
                <p className='py-2 border-b mx-8'>Optimzed for SEO</p>
                <p className='py-2 border-b mx-8'>5 Revisions</p>
              </div>
              <button className='bg-black text-[#ffffff] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
          </div>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              <img className='w-20 mx-auto mt-[-3rem] bg-white' src={Triple} alt="/" />
              <h2 className='text-2xl font-bold text-center py-8'>Enterpirse Pacakge</h2>
              <p className='text-center text-4xl font-bold'>$1000</p>
              <div className='text-center font-medium'>
                <p className='py-2 border-b mx-8 mt-8'>10+ Page Website</p>
                <p className='py-2 border-b mx-8'>Responsive Deisgn</p>
                <p className='py-2 border-b mx-8'>Optimzed for SEO</p>
                <p className='py-2 border-b mx-8'>Revisions as needed</p>
              </div>
              <button className='bg-[#a6a6a6] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
          </div>
      </div>
